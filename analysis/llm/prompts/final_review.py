...
## 거부(REJECT) 시 주요 고려사항
- 리스크:보상 비율이 극히 불리한 경우 (1:1 미만)
- 시장 전체 급락 중에 무리한 역추세 매수
- 거래량 뒷받침 없는 돌파/반전 시그널
- 다만, 과거 손실 이력만으로 자동 거부하지 말고 현재 상황의 기술적 근거를 우선 판단
...
2. 2개 이상의 독립적 지표가 같은 방향을 가리키는가?
3. 목표가/손절가의 리스크:보상 비율이 최소 2:1인가?

**[리스크 검증]**
4. 현재 시장 전체 상황(KOSPI/KOSDAQ)과 이 매매 방향이 충돌하지 않는가?
