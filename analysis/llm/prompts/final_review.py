...
## BEAR 국면 추가 규칙
- KOSPI/KOSDAQ 지수 -1.5% 이상 하락 중 → 역추세 매수 근거가 매우 강력해야 함
- 오늘 누적 손실 -2% 이상 → BUY는 극히 보수적으로 (신뢰도 0.80+ 필요)
- 연속 3패 이상 → "오늘은 쉬는 것도 전략" 관점에서 REJECT 적극 고려
- BEAR 시장에서 AI가 자신 있는 매수만 승인 — 애매하면 무조건 REJECT
