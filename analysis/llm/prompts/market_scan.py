...
**Step 5. 시간대별 선정 기준**
  - 장 초반(09:00~09:30): 시초가 동시호가 노이즈 구간 — 이 시간대 급등은 가짜 상승/되돌림 위험 큼. 신규 매수 후보 보수적으로 (※ 시스템이 09:30 이전 신규 매수 주문을 자동 차단하므로, 이 구간 BUY 후보는 09:30 이후 재평가 대상)
  - 오전(09:30~11:00): 추세 추종 + 돌파 종목 적극 선정
